...
async def trace_exceptions_middleware(request: Request, call_next: Callable) -> JSONResponse:
    """Middleware to trace requests and handle exceptions with distributed tracing.
